...
namespace COP3530 {
    ...
    */
	...
	public:
        ...
        * the list is declared as const. Thus, items that are returned using this operator cannot be changed, and are not
        *  passed by reference.
        */
        ...
        /**
        * Description: Replaces the element at a particular position in the list with a different element. If the position
        * is not in the bounds of 0 to n-1, where n is the amount of elements in the list, a domain error is thrown, and
        * no element is replaced.
        *
        ...
        *
        * @returns T: the object that was replaced in the list.
        */
        ...
        /**
        * Description: Inserts an element at position i in the list. Everything in the list at position i and after
        * position i gets shifted right one in the list. If position i is one past the last position, it gets inserted as
        * the tail. If position i > n where n is the size of the list or i < 0, a domain error exception is thrown.
        *
        ...
        */
        ...
        /**
        * Description: Adds an element to the front of the list, pushing all positions one position back in the list.
        *
        ...
        */
        ...
        /**
        * Description: Removes an element at a specified position, causing all elements after it to shift one left in
        * the list. If the position specified is not within the scope of the list, where -1 < scope < n elements, a
        ...
        */
        ...
        /**
        * Description: Pops the element on the end of the list off of the list. If there is nothing in the list to return,
        * a length error is thrown.
        *
        ...
        */
        ...
        /**
        * Description: Pops off the element at the front of the list. If there is nothing in the list to return,
        * a length error is thrown.
        *
