...
namespace COP3530 {
	...
	public:
		...
		public:
			explicit CDAL_Iter(Node* current = NULL, int pos = NULL, const CDAL* src = NULL) : current(current), total(pos), ref(src) {}
        ...
        public:
            explicit CDAL_Const_Iter(Node* current = NULL, int pos = NULL, const CDAL* src = NULL) : current(current), total(pos), ref(src) {}
